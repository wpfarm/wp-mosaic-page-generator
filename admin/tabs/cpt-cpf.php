...
<div class="wpmpg-welcome-panel">
    <div class="row item first uploader">
        <div class="col col-9 info mid">
            <div class="row label"><?php _e('Custom Fields for', 'wp-mosaic-page-generator'); ?> <?php echo $cpt->cpt_name;?></div>
            <div class="row description"><?php _e('Here you can manage your custom fields.', 'wp-mosaic-page-generator'); ?></div>
        </div>
